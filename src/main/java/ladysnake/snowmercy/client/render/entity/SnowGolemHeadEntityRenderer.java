...
public class SnowGolemHeadEntityRenderer extends EntityRenderer<SnowGolemHeadEntity> {
    ...
    public Identifier getTexture(SnowGolemHeadEntity golemHeadEntity) {
        return SnowMercyClient.GOLEM_MODELS_AND_TEXTURES.get(golemHeadEntity.getGolemType()).getTexture();
    }

    public WeaponizedSnowGolemEntityModel getModel(SnowGolemHeadEntity golemHeadEntity) {
        return (WeaponizedSnowGolemEntityModel) SnowMercyClient.GOLEM_MODELS_AND_TEXTURES.get(golemHeadEntity.getGolemType()).getEntityModel();
    }
